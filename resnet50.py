...
nb_classes = model.get_layer('fc1000').output.shape[1]		# get number of classes
...
cv2.imwrite("gradcam_resnet50.jpg", cam)
...
cv2.imwrite("guided_gradcam_resnet50.jpg", deprocess_image(gradcam))